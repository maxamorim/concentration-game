...
export class NormalPage {
    ...
    saveScore() {
        this.apiConcentrationService.saveScore(this.normal).then((result) => {
            console.log(result);
        }, (err) => {
            console.log(err);
        });
    ...
    showPageResume() {
        ...
        this.saveScore();
        this.navCtrl.push(ResumePage, {page: 'normal', score: this.normal.score, time: this.normal.time});
    }

    showPageFail() {
        clearInterval(this.interval);
        this.navCtrl.push(FailPage, {page: 'normal', score: this.normal.score, time: this.normal.time});
    }
